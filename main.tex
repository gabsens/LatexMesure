...
$\bullet$ Soient $a,b\in \mathbb R$. Soit $a_n\in \mathbb Q^{\mathbb N}$ une suite croissante telle que $a_n\to a$ et $b_n$ décroissante telle que $b_n\to b$. Alors  $$\begin{align}\mu((a,b]) &= \mu ((a,b)) \\&= \mu(\cup_n(a_n,b_n))\\&=\lim_n \mu((a_n,b_n)) \\&= \lim_n \mu((a_n,b_n])\\&=(b_n-a_n)\mu((0,1]) \\ &= (b-a)\mu((0,1])\end{align}$$\newline
