...
\subsection{} \fbox{
\parbox{0.9\textwidth}{
Soit $(X,\mathcal A)$ mesurable, $D$ une partie dénombrable de $X$, $\nu$ la mesure de comptage sur $D$ et $f:(X, \mathcal A)\to (\mathbb R, \mathcal B(\mathbb R))$ mesurable positive. Montrer que $\int f d\nu = \sum_{t\in D} f(t)$
}}\\ \\
